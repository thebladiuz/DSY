...
<body class="bg-light">
          ...
          <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="border bg-light p-3 rounded mb-3">
              ...
              while($row = mysqli_fetch_assoc($facilities_q))
              {
                echo<<<facilities
                <div class="mb-2">
                  <input type="checkbox" onclick="fetch_rooms()" name="facilites" value="$row[id]" class="form-check-input shadow-none me-1" id="$row[id]">
  ...
  <script>
    ...
    function fetch_rooms() 
    {
      ...
      xhr.open("GET", "http://34.126.67.208:8080/admin/ajax/rooms.php?fetch_rooms&chk_avail="+chk_avail+"&guests="+guests+"&facility_list="+facility_list, true);

      xhr.onprogress = function(){
        rooms_data.innerHTML = 
        ' <div class="spinner-border text-info mb-3 d-block mx-auto" id="loader" role="status"> <span class="visually-hidden">Loading...</span> </div>';
