...
// require('../inc/sendgrid/sendgird-php.php')
...
function sendMail($uemail,$name,$token) 
{
    ...
    $email ->setFrom("text@example.com", "Example User");
    $email -> setSubject("Send with SendGrid is Fun");
    ...
    $email -> addContent(
        ...
        <a href='".SITE_URL."email_confirm.php?email_confirmation=$uemail&token=$token"."'>
        CLICK ME
        </a>
        "
    );
